// ===========================================================================
// v30 SNAPSHOT — fork of the champion v29 (see EVOLUTION.md). The DISPATCHER and
// the whole desperation-acquisition mechanism are VERBATIM v29; v30's only change
// is `./valuation.ts`'s distress GATE (adds `DISTRESS_MARGIN` 1.3, widening
// `isDistressed`). The Bot contract is imported from `../../decision`, not
// snapshotted. Exposed as `v30Bot`.
// ===========================================================================
