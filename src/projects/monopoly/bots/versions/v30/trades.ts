...
// ===========================================================================
// v30 SNAPSHOT — fork of v28 (the champion). v30 pushes SURVIVAL_FACTOR 0.4→0.2 — fork of v17 (the champion; see EVOLUTION.md).
 ...
 *  seller (survival value beyond face). 0.2 means each dollar of cash is worth
 *  $1.20 in positionValue to a seller on the brink — they'd sell a lot worth
 *  $100 in positionValue for ~$83 in cash. */
const SURVIVAL_FACTOR = 0.2;
