// ===========================================================================
// v33 SNAPSHOT — fork of the champion v29 (see EVOLUTION.md). The DISPATCHER, the
// desperation-acquisition mechanism, and valuation are VERBATIM v29; v33's only
// change is the MARGINAL-DENIAL GATE in `./trades.ts`'s Offer C (the strong-set
// hot-potato fix). The Bot contract is imported from `../../decision`, not
// snapshotted. Exposed as `v33Bot`.
// ===========================================================================
