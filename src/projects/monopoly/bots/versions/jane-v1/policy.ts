// ===========================================================================
// jane-v1 SNAPSHOT — the first version of the JANE lineage (a bot family distinct
// from Claude; see EVOLUTION.md "Bot lineages"). Branched from Claude's v17. The
// dispatcher (this file) and valuation are VERBATIM from v17; jane-v1's only
// change is in `./trades.ts` — SURVIVAL-PRICING acquisition (a SURVIVAL_FACTOR on
// a distressed seller's incoming cash, so construction sweetens less and the
// buyer acquires set-completers at a DISCOUNT). The Bot contract is imported from
// `../../decision`, not snapshotted. Exposed as `janeV1Bot`.
// ===========================================================================
...
/** The Jane bot — a genuinely challenging, pro-level opponent, and the one
 ...
 *
 *  jane-v1 change (vs the v17 base): `./trades.ts` adds SURVIVAL-PRICING — a
 *  distressed seller values incoming cash above face (a SURVIVAL_FACTOR survival
 *  bonus), so construction sweetens less and the buyer acquires set-completers at
 *  a DISCOUNT. The dispatcher and valuation are carried verbatim from v17. */
