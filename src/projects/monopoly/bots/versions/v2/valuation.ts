// ===========================================================================
// v2 SNAPSHOT — a self-contained copy of the bot's policy (see EVOLUTION.md).
// This file is the v2 fork of `bots/valuation.ts`; it is free to diverge from
// the production champion. v2's only behavioral change lives in `./trades.ts`
// (pricing the rival-monopoly threat); this valuation copy is verbatim, kept
// here so the version is whole and can be run/branched in isolation. Shared,
// non-strategic infrastructure (engine, board geometry) is still imported from
