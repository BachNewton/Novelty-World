// ===========================================================================
// v2 SNAPSHOT — self-contained fork of `bots/policy.ts` (see EVOLUTION.md). The
// dispatcher is verbatim; v2's behavioral change is in `./trades.ts` (pricing
// the rival-monopoly threat). The Bot/BotDecision CONTRACT is stable shared
// infrastructure, so it is imported from the canonical `../../decision`, not
// snapshotted. Exposed as `v2Bot` via `./index.ts`.
// ===========================================================================
