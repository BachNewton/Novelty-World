// ===========================================================================
// v31 SNAPSHOT — fork of v28 (the champion) (the phantom-denial-fixed base; see EVOLUTION.md). The
 ...
 *
 *  v31 change (vs the v28 base): `./valuation.ts` adds DISTRESS-WEIGHTED DENIAL —
 *  the deny premium scales up with the denied opponent's financial distress
 *  (a distressed rival can't recover easily, so denying them is worth more).
 *  The dispatcher and trades are carried verbatim from v28. */
