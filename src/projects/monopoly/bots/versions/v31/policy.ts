// ===========================================================================
// v31 SNAPSHOT — fork of the champion v29 (see EVOLUTION.md). The DISPATCHER is
// VERBATIM v29; v31's only change is in `./trades.ts` (a from-scratch DISTRESS
// grab, Offer E — buying a whole bare monopoly off a distressed owner cheap). The
