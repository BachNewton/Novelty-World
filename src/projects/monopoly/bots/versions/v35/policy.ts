// ===========================================================================
// v35 SNAPSHOT — fork of the champion v29 (see EVOLUTION.md). The DISPATCHER, the
// desperation-acquisition mechanism, and valuation are VERBATIM v29; v35's only
// change is the DENIAL-POSITION OPTION VALUE in `./trades.ts` (the hot-potato fix
// that prices a held completer at the premium it extracts — see that file's header).
// The Bot contract is imported from `../../decision`, not snapshotted. Exposed as
// `v35Bot`.
// ===========================================================================
