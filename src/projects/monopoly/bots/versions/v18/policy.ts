// ===========================================================================
// v18 SNAPSHOT — fork of the CHAMPION v17 (see EVOLUTION.md). The dispatcher and
// trade engine are VERBATIM; v18 PUSHES v17's winning lever further in
// `./valuation.ts` — an even LOWER liquidity reserve (0.3→0.15, cap 300→200, base
// 120→80) — to find where the aggression stops paying. The Bot contract is imported
// from `../../decision`, not snapshotted. Exposed as `v18Bot`.
// ===========================================================================
 ...
 *
 *  v18 change (vs the v17 champion): `./valuation.ts` pushes v17's winning liquidity
 *  reduction FURTHER (`FLOOR_RENT_FRACTION` 0.3→0.15, `FLOOR_CAP` 300→200, `BASE_FLOOR`
 *  120→80) — an even thinner reserve to test where the aggression stops paying. The
 *  dispatcher and the whole trade engine are carried verbatim from v17/v14. */
