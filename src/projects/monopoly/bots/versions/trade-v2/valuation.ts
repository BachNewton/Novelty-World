// ===========================================================================
// claude-v36 SNAPSHOT — fork of the champion jane-v2 (substrate per EVOLUTION.md
// "Two bests"; borrowing across lineages is free). Single change vs jane-v2:
// DENY_FACTOR 0.3 → 0.15 — push the denial knob one more step down its steepest
// historical gradient. jane-v2's biggest single discovery was halving DENY
// 0.6→0.3 (+71 Elo: "wasting resources blocking opponents"); it then moved on to
// other parameters with no recorded sub-0.3 sweep. The real 4-player game vs
// humans (review id 2h0y0y) showed the same failure mode concretely — a bot
// (Rebecca) mortgaged three lots to deny-buy Boardwalk, left itself no buffer,
// and that over-leverage killed it. Hypothesis: denial is still over-weighted at
// 0.3; halving again sharpens self-focus. Everything else is jane-v2 verbatim.
//
// jane-v2 inherited from jane-v1's ancestors: two-pass SPREAD DEVELOPMENT
// planBuild, desperation-pricing acquisition via sellerDistress(), and the
// phantom-denial gate.
// ===========================================================================
