// ===========================================================================
// v29 SNAPSHOT — fork of v28 (the champion) (the phantom-denial-fixed base; see EVOLUTION.md). The
 ...
 *
 *  v29 change (vs the v28 base): `./trades.ts` pushes SURVIVAL_FACTOR 0.4→0.6 —
 *  more aggressive desperation discount. The dispatcher and valuation are
 *  carried verbatim from v28. */
