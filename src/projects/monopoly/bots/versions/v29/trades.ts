...
// ===========================================================================
// v29 SNAPSHOT — fork of v28 (the champion; see EVOLUTION.md).
// v29 pushes SURVIVAL_FACTOR 0.4→0.6 — more aggressive desperation discount. — fork of v17 (the champion; see EVOLUTION.md).
 ...
 *  seller (survival value beyond face). 0.6 means each dollar of cash is worth
 *  $1.60 in positionValue to a seller on the brink — they'd sell a lot worth
 *  $100 in positionValue for ~$63 in cash. */
const SURVIVAL_FACTOR = 0.6;
