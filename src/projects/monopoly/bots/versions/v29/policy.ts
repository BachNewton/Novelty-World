// ===========================================================================
// v29 SNAPSHOT — fork of the champion v28 (see EVOLUTION.md). The DISPATCHER and
// the whole desperation-acquisition mechanism are VERBATIM v28; v29's only change
// is `./valuation.ts`'s `DISTRESS_DISCOUNT` (0.75→1.0 — the maximal discount). The
// Bot contract is imported from `../../decision`, not snapshotted. Exposed as
// `v29Bot`.
// ===========================================================================
