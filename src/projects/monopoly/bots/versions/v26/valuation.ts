// ===========================================================================
// v26 SNAPSHOT — fork of the champion v17 (see EVOLUTION.md). v17's lower liquidity
// reserve is carried VERBATIM; v26's one change lives in `GROUP_WEIGHT` below: it
// RAISES dark-blue's set weight 0.55→0.73 (lead c). This is the FIRST touch of the
// foundational set-VALUE dial since v1, and a SINGLE-VARIABLE bump grounded in
// published landing/ROI data: monopolyland's "desirability per roll" table (which
// folds landing probability AND 3-house ROI) ranks dark-blue #2 (3.10%/roll, ≈ red
// 3.09%), whereas v17's table ranked it #5. 0.73 lifts dark-blue's monopolyBonus
// 413→548 — just above red (544) — landing it at #2 to match the published rank.
// Everything else (liquidity reserve, trades.ts, dispatcher) is v17 verbatim.
// ===========================================================================
 ...
 *  sets (green/yellow) have big printed prices but worse traffic/ROI: orange tops,
 *  then dark-blue and red (near-tied), the high-rent mid sets, with the cheap
 *  light-blue/pink lower in ABSOLUTE value (their edge is cheap, fast ROI, which
 *  their low price already reflects) and brown weakest.
 *
 *  v26 RAISES dark-blue 0.55→0.73 (lead c — first touch of this dial since v1).
 *  Published landing/ROI analysis (monopolyland "desirability per roll", folding
 *  landing probability AND 3-house ROI) ranks dark-blue #2 (3.10%/roll ≈ red's
 *  3.09%); v17's table ranked it #5. 0.73 lifts its bonus 413→548, landing it just
 *  above red (544) to match the published #2. The other seven weights are v17
 *  verbatim. Resulting bonuses ≈ orange 560 > dark-blue 548 > red 544 > yellow 480 >
 *  green 460 > pink 374 > light-blue 320 > brown 84.
