// ===========================================================================
// v5 SNAPSHOT — self-contained fork of `bots/policy.ts` (see EVOLUTION.md).
// Branched from v3. The dispatcher is VERBATIM from v3; v5's behavioral change is
// entirely in `./trades.ts` (TRADE-TO-DENY construction). The Bot/BotDecision
// CONTRACT is stable shared infrastructure, so it is imported from the canonical
// `../../decision`, not snapshotted. Exposed as `v5Bot` via `./index.ts`.
// ===========================================================================
