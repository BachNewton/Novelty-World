// ===========================================================================
// v3 SNAPSHOT — a self-contained copy of the bot's policy (see EVOLUTION.md).
// This file is the v3 fork of `bots/valuation.ts`; it is free to diverge from
// the production champion. v3's behavioral change lives entirely in `./trades.ts`
// (N-way / multi-short trade construction, on top of v2's rival-threat pricing);
// this valuation copy is verbatim, kept here so the version is whole and can be
// run/branched in isolation. Shared, non-strategic infrastructure (engine, board
// geometry) is still imported from the canonical modules — only the *policy* is
// snapshotted.
// ===========================================================================
