// ===========================================================================
// v34 SNAPSHOT — fork of the champion v29 (see EVOLUTION.md). The DISPATCHER, the
// desperation-acquisition mechanism, and valuation are VERBATIM v29; v34's only
// change is the ANTI-CHURN COOLDOWN on Offer C in `./trades.ts` (the strong-set
// hot-potato fix, take 2 — see that file's header). The Bot contract is imported
// from `../../decision`, not snapshotted. Exposed as `v34Bot`.
// ===========================================================================
