// ===========================================================================
// v28 SNAPSHOT — fork of the champion v17 (see EVOLUTION.md). The DISPATCHER is
// VERBATIM; v28's change is the coupled DESPERATION-ACQUISITION hypothesis in
// `./valuation.ts` (the distress model + `distressThreatScale`) and `./trades.ts`
// (the seller-side threat discount in `rivalThreatCost` + the buyer-side note on
// Offer B). The Bot contract is imported from `../../decision`, not snapshotted.
// Exposed as `v28Bot`.
// ===========================================================================
